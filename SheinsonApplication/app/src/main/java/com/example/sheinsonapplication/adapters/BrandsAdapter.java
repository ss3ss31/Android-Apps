...
public class BrandsAdapter extends ArrayAdapter<String> implements SpinnerAdapter {
    ...
    public BrandsAdapter(@NonNull Context context, int myStyleTemplate, String [] myNames, Drawable [] itemImage,Drawable [] itemLogo , String [] myDescs ) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        try {
            if (convertView == null) {
                if (styleTemplate == R.layout.brand_item_view) {
                    LayoutInflater mInflater = (LayoutInflater) mContext.
                            getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                    convertView = mInflater.inflate(styleTemplate, parent, false);
                    mViewHolder.image = (ImageView) convertView.findViewById(R.id.brand_item_image);
                    mViewHolder.name = (TextView) convertView.findViewById(R.id.brand_item_title);
                    mViewHolder.desc = (TextView) convertView.findViewById(R.id.brand_item_desc);
                    mViewHolder.logo = (ImageView) convertView.findViewById(R.id.brand_item_logo);
            ...
            if(styleTemplate==R.layout.brand_item_view)
            {
                if(itemImage[position]==null){
                    ...
                    mViewHolder.logo.setBackgroundResource(R.drawable.no_logo);
